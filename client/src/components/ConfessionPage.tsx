...
const confessionBadges: Badge[] = [
  ...
  },
  {
    ...
    icon: '👑',
    color: 'text-[#F4E3B5]',
    pfpColor: 'from-[#F4E3B5] to-[#F4E3B5]',
  ...
  useEffect(() => {
    const fetchAlias = async () => {
      ...
      try {
        ...
        // If alias doesn't exist yet, that's okay - user will set it
        console.log('No saved alias found, will use generated one');
      }
    };
  ...
  if (showAliasPrompt) {
    return (
      <div className="fixed inset-0 bg-black/95 backdrop-blur-xl flex items-center justify-center p-4 z-50">
        ...
        <div className="relative bg-black/80 backdrop-blur-2xl border border-[#F4E3B5]/20 rounded-3xl p-8 w-full max-w-md">
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              ...
              <div className="relative mx-auto mb-6 w-24 h-24">
                {alias.imageUrl ? (
                  <img 
                    src={alias.imageUrl} 
                    alt="Alias avatar" 
                    className="relative w-24 h-24 rounded-3xl object-cover border-2 border-[#F4E3B5]/30 " 
                  />
                ) : (
                  <div className={`relative w-24 h-24 bg-gradient-to-br ${alias.color} rounded-3xl flex items-center justify-center text-4xl border-2 border-[#F4E3B5]/30 `}>
                    {alias.emoji}
                  </div>
                )}
              </div>
              ...
              <p className="text-[#a1a1aa] text-sm leading-relaxed px-2">
                ...
                <span className="text-[#F4E3B5]/80">Complete privacy guaranteed.</span>
              </p>
            </div>
            ...
            <div className="space-y-6">
                ...
                <div className="flex gap-3">
                  <div className="flex-1 relative">
                    <input
                      ...
                      maxLength={20}
                      className="w-full bg-black/50 backdrop-blur-sm border border-[#F4E3B5]/20 rounded-2xl px-4 py-3 text-white placeholder-zinc-500 focus:border-[#F4E3B5]/50 focus:outline-none focus:ring-2 focus:ring-[#F4E3B5]/20 transition-all duration-300"
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-[#F4E3B5]/5 to-transparent rounded-2xl pointer-events-none"></div>
                  </div>
                  <button
                    onClick={generateNewAlias}
                    className="w-12 h-12 bg-black/50 backdrop-blur-sm hover:bg-black/70 text-[#F4E3B5] hover:text-[#F4E3B5] rounded-2xl transition-all duration-300 border border-[#F4E3B5]/20 hover:border-[#F4E3B5]/40 flex items-center justify-center group"
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-black/50 backdrop-blur-sm hover:bg-black/70 text-[#F4E3B5] rounded-2xl border border-[#F4E3B5]/20 hover:border-[#F4E3B5]/40 transition-all duration-300 text-sm font-medium"
                  >
                    📸 Upload Photo
                  </button>
                  {alias.imageUrl && (
              ...
              <div className="flex items-center justify-between pt-6 border-t border-zinc-800/50">
                ...
                <button
                  ...
                  className="relative bg-gradient-to-r from-[#F4E3B5] to-[#F4E3B5] hover:from-[#F4E3B5] hover:to-[#F4E3B5] text-black px-8 py-3 rounded-2xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 hover:scale-105 disabled:hover:scale-100"
                >
  ...
  if (showDisclaimer) {
    return (
      <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center p-6">
        <div className="bg-black border border-[#F4E3B5]/30 rounded-2xl p-8 max-w-2xl w-full">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 rounded-xl bg-[#F4E3B5]/30 flex items-center justify-center border border-[#F4E3B5]/30">
              <Shield className="w-6 h-6 text-[#F4E3B5]" />
            </div>
            <h3 className="text-2xl font-bold text-white">Complete Anonymity Guaranteed</h3>
          </div>
          <div className="bg-[#F4E3B5]/10 border border-[#F4E3B5]/20 rounded-lg p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-[#F4E3B5] font-semibold mb-2">Important Reminder</h4>
          ...
          <div className="flex items-center justify-end">
            <button
              ...
              className="bg-gradient-to-r from-softgold-500 to-softgold-600 hover:from-softgold-600 hover:to-softgold-700 text-black px-6 py-2 rounded-lg font-medium"
            >
              I understand
            </button>
          </div>
  ...
  return (
    <div className="campus-theme flex flex-col h-full bg-black relative overflow-hidden">
      ...
      <PageHeader
        ...
        searchPlaceholder="Search confessions, authors, or poll questions..."
      />
        ...
        <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div key={confession.id} className={`relative group py-6 px-2 ${confession.isExplicit ? 'border-2 border-red-500/40 rounded-3xl bg-red-900/5 backdrop-blur-sm' : ''}`}>
                    ...
                    <div className="relative">
                      {confession.authorAlias?.imageUrl ? (
                        <img 
                          ...
                          alt="Author avatar" 
                          className="w-10 h-10 rounded-full object-cover border-2 border-[#F4E3B5]/20 " 
                        />
                      ) : (
                        <div className={`w-10 h-10 rounded-full bg-gradient-to-br ${confession.authorAlias?.color || 'from-gray-500 to-gray-600'} flex items-center justify-center text-white text-lg font-bold  border-2 border-[#F4E3B5]/20`}>
                          {confession.authorAlias?.emoji || '👤'}
                        </div>
                      )}
                      <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-black rounded-full flex items-center justify-center border border-[#F4E3B5]/30">
                        <EyeOff className="w-2.5 h-2.5 text-[#F4E3B5]" />
                      </div>
                    </div>
                    <div>
                ...
                {(!confession.isExplicit || revealedContent[confession.id]) && (
                  <div className="hidden md:flex flex-col items-center self-start gap-3">
                    <div className="bg-black/50 backdrop-blur-sm rounded-2xl p-3 border border-[#F4E3B5]/10 ">
                      <button
                  ...
                  <div className={`flex-1 ${confession.isExplicit ? 'relative' : ''}`}>
                    ...
                    {/* Poll Section */}
                    {confession.poll && (
                      <div className={`mb-6 relative bg-black/50 backdrop-blur-sm rounded-3xl p-6 border border-[#F4E3B5]/10  z-10 ${
                        confession.isExplicit && !revealedContent[confession.id] ? 'blur-lg' : ''
                      }`}>
                        {/* Glassmorphism overlay */}
                        <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent rounded-3xl"></div>
                        ...
                        <div className="relative z-10">
                          ...
                          <div className="flex items-center gap-3 mb-6">
                            <div className="w-10 h-10 bg-[#F4E3B5]/20 rounded-2xl flex items-center justify-center">
                              ...
                              return (
                                <button
                                  ...
                                  className={`w-full group relative overflow-hidden rounded-2xl border transition-all duration-300 hover:scale-[1.02] ${
                                    isSelected
                                      ? 'border-[#F4E3B5]/50 bg-[#F4E3B5]/20 '
                                      : 'border-[#F4E3B5]/20 hover:border-[#F4E3B5]/40 hover:bg-[#F4E3B5]/10'
                                  }`}
                                >
                                  ...
                                  <div 
                                    className={`absolute inset-0 transition-all duration-700 ${
                                      isSelected 
                                        ? 'bg-gradient-to-r from-[#F4E3B5]/30 to-[#F4E3B5]/20' 
                                        : 'bg-gradient-to-r from-[#F4E3B5]/10 to-transparent'
                                    }`}
                                  ...
                                  <div className="relative z-10 flex items-center justify-between p-4">
                                    <div className="flex items-center gap-3">
                                      <div className={`w-6 h-6 rounded-full border-2 transition-all duration-300 ${
                                        isSelected 
                                          ? 'border-[#F4E3B5] bg-[#F4E3B5]' 
                                          : 'border-zinc-400 group-hover:border-[#F4E3B5]'
                                      }`}>
                                        {isSelected && (
                                      ...
                                      <span className={`font-medium transition-colors duration-300 ${
                                        isSelected ? 'text-[#F4E3B5]' : 'text-zinc-200 group-hover:text-[#F4E3B5]'
                                      }`}>
                                        {option}
                                      </span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                      <span className={`text-sm font-semibold transition-colors duration-300 ${
                                        isSelected ? 'text-[#F4E3B5]' : 'text-[#a1a1aa] group-hover:text-[#F4E3B5]'
                                      }`}>
                                        {percentage.toFixed(0)}%
                                      </span>
                                      <span className={`text-xs transition-colors duration-300 ${
                                        isSelected ? 'text-[#F4E3B5]' : 'text-zinc-500 group-hover:text-[#F4E3B5]'
                                      }`}>
                                        ({optionVotes})
                                      </span>
                                    </div>
                          ...
                          {/* Poll Stats */}
                          <div className="mt-4 pt-4 border-t border-[#F4E3B5]/10">
                            ...
                            return (
                              <button
                                ...
                                className={`group flex items-center gap-2 px-4 py-2.5 rounded-2xl text-sm border transition-all duration-300 hover:scale-105 ${
                                  data.userReacted 
                                    ? 'border-[#F4E3B5]/50 text-[#F4E3B5] bg-[#F4E3B5]/20 ' 
                                    : 'border-[#F4E3B5]/20 text-zinc-300 hover:border-[#F4E3B5]/40 hover:bg-[#F4E3B5]/10 hover:text-[#F4E3B5]'
                                }`}
                ...
                {/* Modern Footer */}
                {(!confession.isExplicit || revealedContent[confession.id]) && (
                <div className="flex items-center justify-between pt-6 border-t border-[#F4E3B5]/5 relative">
                  <div className="flex items-center gap-6">
                    {/* Mobile vote controls */}
                    <div className="flex md:hidden items-center gap-3">
                      <div className="flex items-center gap-3 bg-black/50 backdrop-blur-sm rounded-2xl p-2 border border-[#F4E3B5]/10">
                        <button 
                          onClick={() => toggleVote(confession.id, 1)} 
                    ...
                    <button 
                      onClick={() => setSelectedConfessionId(confession.id)}
                      className="flex items-center gap-3 px-4 py-2.5 rounded-2xl text-zinc-300 hover:text-[#F4E3B5] hover:bg-[#F4E3B5]/10 transition-all duration-300 border border-[#F4E3B5]/10 hover:border-[#F4E3B5]/20 group hover:scale-105"
                    >
                ...
                {showReplies[confession.id] && (
                  <div className="mt-6 pt-6 border-t border-[#F4E3B5]/10">
                    {/* Header */}
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-[#F4E3B5]/20 rounded-2xl flex items-center justify-center">
                          <MessageCircle className="w-4 h-4 text-[#F4E3B5]" />
                        </div>
                        <div>
                      ...
                      {loadingReplies[confession.id] && (
                        <div className="w-6 h-6 border-2 border-[#F4E3B5] border-t-transparent rounded-full animate-spin"></div>
                      )}
                    </div>
                    ...
                    <div className="space-y-4 mb-6">
                      {confession.repliesList && confession.repliesList.length > 0 ? confession.repliesList.map((reply, index) => (
                          ...
                          <div className="flex gap-4">
                            ...
                            <div className="relative flex-shrink-0">
                              {reply.authorAlias?.imageUrl ? (
                                ...
                                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#F4E3B5] to-[#F4E3B5] flex items-center justify-center text-black text-sm font-bold border-2 border-[#F4E3B5]/20 ">
                                  {reply.authorAlias?.emoji || '👤'}
                                </div>
                              )}
                              {/* Connection line for threading */}
                              {index < (confession.repliesList?.length || 0) - 1 && (
                                <div className="absolute top-12 left-1/2 w-0.5 h-8 bg-gradient-to-b from-[#F4E3B5]/20 to-transparent transform -translate-x-px"></div>
                              )}
                            </div>
                            ...
                            <div className="flex-1 min-w-0">
                              {/* Reply Bubble */}
                              <div className="relative bg-[#27272a]/40 backdrop-blur-sm border border-[#F4E3B5]/10 rounded-3xl rounded-tl-lg p-4  group-hover:shadow-[#F4E3B5]/5 transition-all duration-300">
                                {/* Glassmorphism overlay */}
                              ...
                              <div className="flex items-center justify-between mt-3 px-2">
                                ...
                                {/* Reply Voting */}
                                <div className="flex items-center gap-2 bg-[#27272a]/30 backdrop-blur-sm rounded-2xl p-1 border border-[#F4E3B5]/10">
                                  <button
                        ...
                        <div className="text-center py-12 bg-black/40 backdrop-blur-sm rounded-3xl border border-[#F4E3B5]/10">
                          <div className="w-16 h-16 bg-[#F4E3B5]/10 rounded-3xl mx-auto mb-4 flex items-center justify-center">
                            <MessageCircle className="w-8 h-8 text-[#F4E3B5]/60" />
                          </div>
                    ...
                    {/* Modern Reply Input */}
                    <div className="bg-black/40 backdrop-blur-sm rounded-3xl p-4 border border-[#F4E3B5]/10">
                        ...
                        {/* Input Area */}
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3 bg-black/60 backdrop-blur-sm rounded-2xl border border-[#F4E3B5]/10 p-1">
                            <input
                              type="text"
                            ...
                            <div className="relative">
                              <button
                                ...
                                className="w-10 h-10 flex items-center justify-center rounded-xl text-xl text-zinc-300 hover:text-[#F4E3B5] hover:bg-[#F4E3B5]/10 transition-colors"
                              ...
                              {openReplyEmojiPickerId === confession.id && (
                                <div className={`absolute z-50 mt-2 top-full bg-black/90 border border-[#F4E3B5]/20 rounded-2xl p-2 shadow-xl backdrop-blur-sm max-w-[calc(100vw-24px)] ${
                            ...
                            <button
                              ...
                              className={`relative w-12 h-12 bg-gradient-to-r from-[#F4E3B5] to-[#F4E3B5] hover:from-[#F4E3B5] hover:to-[#F4E3B5] text-black rounded-2xl flex items-center justify-center transition-all duration-300   hover:scale-105 group ${
                ...
                {index < filteredConfessions.length - 1 && (
                  <div className="border-b border-[#F4E3B5]/20 mt-8 mb-2"></div>
                )}
              </div>
            ))}
          </div>
          ...
          {loading && (
            <div className="flex flex-col items-center py-12">
              ...
              <div className="relative mb-4">
                <div className="w-12 h-12 bg-gradient-to-r from-[#F4E3B5] to-[#F4E3B5] rounded-full"></div>
                <div className="absolute inset-0 w-12 h-12 border-4 border-[#F4E3B5]/30 border-t-[#F4E3B5] rounded-full animate-spin"></div>
              </div>
          ...
          {hasMore && !loading && (
            <div ref={loadMoreRef} className="h-8 flex items-center justify-center">
              <div className="w-2 h-2 bg-[#F4E3B5]/30 rounded-full"></div>
            </div>
          )}
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#F4E3B5] hover:bg-[#F4E3B5]/90 text-[#18181b] rounded-full shadow-lg shadow-[#F4E3B5]/50 transition-all duration-300 hover:scale-110 flex items-center justify-center group"
