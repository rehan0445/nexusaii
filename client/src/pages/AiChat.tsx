...
function AiChat() {
  ...
  if (loadingCharacters) {
    ...
    return (
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-5 p-4">
  ...
  return (
    <div className={`min-h-screen ${mainBg}`}>
      ...
      {/* Header */}
      <header className={`border-b ${borderColor} ${mainBg}/50 backdrop-blur-sm fixed ${isDesktop ? 'left-56' : 'left-0'} right-0 top-0 z-50`}>
              ...
              {!showFavorites && (
                <div className="flex items-center gap-2" ref={filterContainerRef}>
                  <button
                    ...
                    className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 ${
                      filtersExpanded
                        ? incognitoMode
                          ? "bg-orange-500 text-white hover:bg-orange-500/90 focus:ring-orange-500"
                          : "bg-gold text-zinc-900 hover:bg-gold/90 focus:ring-gold"
                        : incognitoMode
                          ? `${sideMenuBg} text-zinc-200 hover:bg-black/80 focus:ring-orange-500`
                          : "bg-zinc-800 text-zinc-200 hover:bg-zinc-700/80 focus:ring-gold"
                    }`}>
                  ...
                  <button
                    onClick={() => setShowFindByIdModal(true)}
                    className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 ${
                      incognitoMode
                        ? `${sideMenuBg} text-zinc-200 hover:bg-black/80 focus:ring-orange-500`
                        : "bg-zinc-800 text-zinc-200 hover:bg-zinc-700/80 focus:ring-gold"
      ...
      {/* Main Content */}
      <main className={`${isDesktop ? 'ml-56' : ''} px-4 sm:px-6 pt-16 sm:pt-20 pb-24 sm:pb-12`}>
            ...
            <div>
              ...
              {Object.keys(filteredCharacters).length === 0 ? (
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-5">
      ...
      {showFindByIdModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-zinc-800 rounded-2xl w-full max-w-md mx-4">
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-bold text-white">Find Character by ID</h2>
                <button
                  onClick={() => setShowFindByIdModal(false)}
              ...
              <div className="space-y-4">
                <p className="text-zinc-300 text-sm">
                  Enter a character ID to quickly find and view their profile.
                </p>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., naruto-uzumaki, math-maven..."
                  ...
                  <p className="text-xs text-zinc-500 mt-1">
                    You can find character IDs in the Share menu of any character.
                  </p>
                </div>
                ...
                <div className="flex space-x-3 pt-4">
                  ...
                  <button
                    onClick={findCharacterById}
                    disabled={!characterIdInput.trim() || findByIdLoading}
                    className={`flex-1 py-3 rounded-lg transition-colors ${
                      characterIdInput.trim() && !findByIdLoading
                        ? 'bg-softgold-500 hover:bg-softgold-500 text-white'
                        : 'bg-zinc-700 text-zinc-400 cursor-not-allowed'
                    }`}
                  >
                    {findByIdLoading ? 'Searching...' : 'Find Character'}
                  </button>
                </div>
              </div>
            </div>
