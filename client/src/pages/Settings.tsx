  ...
  return (
    <div className={`min-h-screen ${mainBg}`}>
      ...
      {isSmallScreen && (
        ...
        >
          {/* Drawer Header */}
          <div className="h-14 px-4 border-b border-zinc-700/50 flex items-center justify-between">
            <div className="flex items-center gap-3">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
            <div className="bg-zinc-900 rounded-2xl max-w-md w-full border border-zinc-800 shadow-2xl">
              ...
              <div className="flex items-center justify-between p-6 border-b border-zinc-800">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">We're here to help</p>
                  </div>
                </div>
                <button
              ...
              <div className="p-6 pt-0">
                <button
                  onClick={() => setShowHelpModal(false)}
                  className="w-full px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-white rounded-lg font-medium transition-colors"
                >
                  Close
                </button>
              </div>
